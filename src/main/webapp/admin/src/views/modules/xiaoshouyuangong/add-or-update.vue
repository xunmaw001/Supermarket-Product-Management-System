               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="工号" prop="xiaoshouyuangongUuidNumber">
                       <el-input v-model="ruleForm.xiaoshouyuangongUuidNumber"
                                 placeholder="工号" clearable  :readonly="ro.xiaoshouyuangongUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="销售员工姓名" prop="xiaoshouyuangongName">
                       <el-input v-model="ruleForm.xiaoshouyuangongName"
                                 placeholder="销售员工姓名" clearable  :readonly="ro.xiaoshouyuangongName"></el-input>
                   </el-form-item>
                   <div v-else>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="销售员工手机号" prop="xiaoshouyuangongPhone">
                       <el-input v-model="ruleForm.xiaoshouyuangongPhone"
                                 placeholder="销售员工手机号" clearable  :readonly="ro.xiaoshouyuangongPhone"></el-input>
                   </el-form-item>
                   <div v-else>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="销售员工身份证号" prop="xiaoshouyuangongIdNumber">
                       <el-input v-model="ruleForm.xiaoshouyuangongIdNumber"
                                 placeholder="销售员工身份证号" clearable  :readonly="ro.xiaoshouyuangongIdNumber"></el-input>
                   </el-form-item>
                   <div v-else>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="电子邮箱" prop="xiaoshouyuangongEmail">
                       <el-input v-model="ruleForm.xiaoshouyuangongEmail"
                                 placeholder="电子邮箱" clearable  :readonly="ro.xiaoshouyuangongEmail"></el-input>
                   </el-form-item>
                   <div v-else>
        ...
        data() {
            return {
                ...
                ro:{
                    username: false,
                    password: false,
                    xiaoshouyuangongUuidNumber: false,
                    xiaoshouyuangongName: false,
                    xiaoshouyuangongPhone: false,
                    xiaoshouyuangongIdNumber: false,
                    xiaoshouyuangongPhoto: false,
                    sexTypes: false,
                    xiaoshouyuangongEmail: false,
                },
                ruleForm: {
                    username: '',
                    password: '',
                    xiaoshouyuangongUuidNumber: new Date().getTime(),
                    xiaoshouyuangongName: '',
                    xiaoshouyuangongPhone: '',
                    xiaoshouyuangongIdNumber: '',
                    xiaoshouyuangongPhoto: '',
                    sexTypes: '',
                    xiaoshouyuangongEmail: '',
                },
                sexTypesOptions : [],
                rules: {
                   username: [
                   ...
                   xiaoshouyuangongUuidNumber: [
                              { required: true, message: '工号不能为空', trigger: 'blur' },
                          ],
                   xiaoshouyuangongName: [
                              { required: true, message: '销售员工姓名不能为空', trigger: 'blur' },
                          ],
                   xiaoshouyuangongPhone: [
                              {  required: true, message: '销售员工手机号不能为空', trigger: 'blur' },
                   ...
                   xiaoshouyuangongIdNumber: [
                              { required: true, message: '销售员工身份证号不能为空', trigger: 'blur' },
                              { pattern: /^[1-9]\d{5}(18|19|([23]\d))\d{2}((0[1-9])|(10|11|12))(([0-2][1-9])|10|20|30|31)\d{3}[0-9Xx]$/,
                                message: '销售员工身份证号格式有误！',
                                trigger: 'blur'
                              }
                          ],
                   xiaoshouyuangongPhoto: [
                              { required: true, message: '销售员工头像不能为空', trigger: 'blur' },
                          ],
                   sexTypes: [
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`xiaoshouyuangong/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.xiaoshouyuangongCrossAddOrUpdateFlag = false;
                                        this.parent.search();
