               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="单位" prop="shangpinDanwei">
                       <el-input v-model="ruleForm.shangpinDanwei"
                                 placeholder="单位" clearable  :readonly="ro.shangpinDanwei"></el-input>
                   </el-form-item>
                   <div v-else>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="进价" prop="shangpinJinjiaMoney">
                       <el-input v-model="ruleForm.shangpinJinjiaMoney"
                                 placeholder="进价" clearable  :readonly="ro.shangpinJinjiaMoney"></el-input>
                   </el-form-item>
                   <div v-else>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="售价" prop="shangpinShoujiaMoney">
                       <el-input v-model="ruleForm.shangpinShoujiaMoney"
                                 placeholder="售价" clearable  :readonly="ro.shangpinShoujiaMoney"></el-input>
                   </el-form-item>
                   <div v-else>
...
<script>
    ...
    export default {
        data() {
            return {
                ...
                ro:{
                    ...
                    shangpinDanwei: false,
                    shangpinJinjiaMoney: false,
                    shangpinShoujiaMoney: false,
        ...
        created() {
            ...
            if (this.role != "管理员"){
                this.ro.shangpinJinjiaMoney = true;
                this.ro.shangpinShoujiaMoney = true;
            }
